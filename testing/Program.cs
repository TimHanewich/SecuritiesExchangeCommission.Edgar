...
namespace testing
{
    class Program
    {
        ...
        {
            string content = System.IO.File.ReadAllText("C:\\Users\\TaHan\\Downloads\\msft_form4_fail.xml");
            ...
            // EdgarSearch es = EdgarSearch.CreateAsync("intc", "4", null, EdgarSearchOwnershipFilter.include).Result;
